...
export const services: ServiceGroup[] = [
  {
    ...
    short:
      "Habilitaciones comerciales, permisos de obra, excavación y reformas ante el GCBA. Acompaño cada trámite hasta el certificado.",
    description:
      "Acompaño cada etapa del trámite ante el Gobierno de la Ciudad: del diagnóstico al certificado final. Trabajo con comercios, oficinas, locales gastronómicos, viviendas y obras civiles bajo Ley 5.920 (Sistema de Autoprotección) y la normativa de habilitaciones del GCBA. La presentación va con mi firma y matrícula.",
    items: [
  ...
  },
  {
    ...
    description:
      "Realizo las mediciones obligatorias bajo las Resoluciones SRT 84/12 (iluminación), 85/12 (ruido) y la normativa ergonómica vigente. No te entrego solo el protocolo: te explico qué dice, qué riesgos detectó y qué hay que corregir. Cada protocolo lleva mi firma y matrícula.",
    items: [
  ...
  },
  {
    ...
    short:
      "Proyecto, instalación, mantenimiento y certificación contra incendio. Coordino la obra y la presentación ante AGC y Bomberos.",
    description:
...
export const howIWork: { icon: string; title: string; text: string }[] = [
  {
    ...
    title: "Diagnóstico",
    text: "Hablamos por WhatsApp o nos juntamos por videollamada. Entiendo el caso, reviso lo que ya tenés y te digo qué hace falta — sin compromiso.",
  },
  {
    icon: "ph:hard-hat-bold",
    title: "Visita técnica",
    text: "Voy a tu local u obra. Hago el relevamiento, las mediciones con instrumental propio y registro todo lo que hay que corregir.",
  },
  {
